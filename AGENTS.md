...
- Local directories to inspect first when relevant: `.github/`, `docs/`, `examples/`, `registry/`, `rust/`, `schemas/`, `scripts/`, `skills/`, `src/`.
...
- `pnpm run test:e2e-dry-run`: run the configured test suite for this scope.
