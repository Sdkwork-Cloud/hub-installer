...
Domain: device
Capability: hub-installer-rs
Package type: rust-crate
Status: standard

This README is the SDKWork module entrypoint for `hub-installer-rs`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../sdkwork-specs/`.
